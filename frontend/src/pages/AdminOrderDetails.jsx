...
import { fetchSingleOrderAPI } from "../api/adminAPI";
...
function AdminOrderDetails() {
    ...
    useEffect(() => {
        async function fetchOrderDetails() {
            try {
                const orderData = await fetchSingleOrderAPI(id);
        ...
        // Cleanup function! This wipes the single order from Redux when you leave the page.
        return () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                {/* Back Button */}
                <Link to="/admin/orders" className="inline-flex items-center text-sm font-bold text-indigo-600 hover:text-indigo-800 mb-6 transition-colors">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-base font-semibold text-gray-800 leading-relaxed">
                                ...
                                <span className="text-sm font-medium text-gray-500">{order.user?.email}</span>
                            </p>
                        </div>
                        ...
                        {/* Column 3: Payment Info (Pushed to the right edge) */}
